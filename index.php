...
<section id="testimonial-form" style="padding: 50px 0; background: #fff;">
  ...
  <section id="faq" class="faq">
    <div class="container">
      <div class="section-title">
        <h2>FAQ</h2>
        <p>Berikut adalah pertanyaan yang sering ditanyakan oleh pelanggan :</p>
      </div>

      <div class="accordion" id="accordionExample">
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingOne">
            <button class="text-style-1 accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
              aria-expanded="false" aria-controls="collapseOne">
              Bagaimana cara merawat kuku setelah nail art?
            </button>
          </h2>
          <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
            data-bs-parent="#accordionExample">
            <div class="text-style-1 accordion-body">
              <strong>Untuk merawat kuku setelah nail art</strong>, hindari penggunaan produk berbahan kimia keras, gunakan sarung tangan saat mencuci piring, dan aplikasikan pelembap kuku secara teratur.
            </div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingFour">
            <button class="text-style-1 accordion-button collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
              Apa Rekomendasi Desain Nail Art untuk Perempuan?
            </button>
          </h2>
          <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
            data-bs-parent="#accordionExample">
            <div class="text-style-1 accordion-body">
              <strong>Rekomendasi desain nail art untuk perempuan</strong> bisa termasuk motif floral, glitter, atau warna-warna cerah seperti merah muda dan ungu.
            </div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingFive">
            <button class="text-style-1 accordion-button collapsed" type="button" data-bs-toggle="collapse"
              ...
              Ada Berapa Jenis Layanan Nail Art di ohmy.nailart?
            </button>
          </h2>
          <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
            data-bs-parent="#accordionExample">
            <div class="text-style-1 accordion-body">
              <p><strong>Layanan nail art di ohmy.nailart</strong></p>
              <ul>
                <li>Basic: Pengaplikasian warna dasar dengan ketahanan 3-4 hari</li>
                <li>Standard: Pengaplikasian warna dengan desain sederhana, ketahanan 5-7 hari</li>
                <li>Premium: Pengaplikasian warna dengan desain rumit dan aksen, ketahanan 8-12 hari</li>
              </ul>
            </div>
          </div>
        </div>
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingSix">
            <button class="text-style-1 accordion-button collapsed" type="button" data-bs-toggle="collapse"
              ...
              Ada Berapa Variant Desain Nail Art di ohmy.nailart?
            </button>
          </h2>
          <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
            data-bs-parent="#accordionExample">
            <div class="text-style-1 accordion-body">
              <strong>ohmy.nailart menyediakan lebih dari 60 variant desain nail art</strong> sehingga pelanggan dapat memilih sesuai dengan apa yang diinginkan.
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="row align-items-center">
              <div class="col-12">
                ...
                <div class="icon-and-text">
                  <div class="telephone-icon">
                    <i class="bi bi-telephone-fill"
                      style="font-size: 30px; color: rgb(0, 0, 0); margin-right: 10px;"></i>
                ...
                <div class="social-links">
                  <a href="https://www.instagram.com/ohmy.nailart/" title="link instagram" target="_blank"><i
                      class="fab fa-instagram" style="color: #000000;"></i></a>
                  <a href="https://api.whatsapp.com/send/?phone=6281333770901&text&type=phone_number&app_absent=0" title="link whatsapp"
                    target="_blank"><i class="fab fa-whatsapp" style="color: #000000;"></i></a>
                </div>
              </div>
            </div>
          </div>
