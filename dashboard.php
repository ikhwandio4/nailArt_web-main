...
<body>
  ...
  // Query untuk mendapatkan data desain yang sering dibeli
$query = "
SELECT 
                            ...
                            <table class="table text-nowrap mb-0 align-middle">
                                <thead class="text-dark fs-4">
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Jumlah Pelanggan</h6>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($items as $index => $item) : ?>
                                        <tr>
                                            <td class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0"><?php echo $index + 1; ?></h6>
                                            </td>
                                            <td class="border-bottom-0">
                                                <h6 class="fw-semibold mb-1"><?php echo htmlspecialchars($item['nama_item']); ?></h6>
                                            </td>
                                            <td class="border-bottom-0">
                                                <p class="mb-0 fw-normal"><?php echo $item['jumlah_pembelian']; ?></p>
                                            </td>
                                            <td class="border-bottom-0">
                                                <p class="mb-0 fw-normal"><?php echo $item['jumlah_pelanggan']; ?></p>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
